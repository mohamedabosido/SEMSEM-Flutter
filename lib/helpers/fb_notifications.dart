...
mixin FirebaseNotifications {
  ...
  static Future<void> initNotifications() async {
    ...
    if (!kIsWeb) {
      ...
      channel = const AndroidNotificationChannel(
        // every app has its own channel/s.
        'Tokoto_notifications_channel',
        'Tokoto_notifications_channel',
        description:
  ...
  // GENERAL (Android & iOS)
  void manageNotificationAction(context) {
    FirebaseMessaging.onMessageOpenedApp.listen((RemoteMessage message) {
      _controlNotificationNavigation(data: message.data , context: context);
    });
  }

  void _controlNotificationNavigation(
      {required Map<String, dynamic> data, context}) {
    print('Data: $data');
    if (data['page'] != null) {
      switch (data['page']) {
        case 'products':
